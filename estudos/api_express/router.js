...
module.exports = function (app) {
  ...
  // Insert menu
  menuRoutes.post('/', requireAuth, MenuController.insert);

  // List menu
  menuRoutes.get('/', requireAuth, MenuController.list);

  // Search menu
  menuRoutes.get('/search/:menu', requireAuth, MenuController.search);
